...
export const MONSTERS = {
  giant_rat: {
    name: 'Giant Rat', creatureType: 'animal', hp: '1d8+1', ac: 14, attack: 2, damage: '1d4', speed: 3.2, xp: 25,
    saves: { fort: 3, ref: 3, will: 1 }, aggro: 5, color: '#8a7a6a', shape: 'small', size: 0.6,
    loot: { gold: [0, 2], items: [{ id: 'rat_tail', chance: 1 }] },
  },
  dire_rat: {
    name: 'Dire Rat', creatureType: 'animal', hp: '2d8+3', ac: 15, attack: 4, damage: '1d6+1', speed: 3.4, xp: 60,
    saves: { fort: 4, ref: 4, will: 2 }, aggro: 6, color: '#5a4a3a', shape: 'small', size: 0.8,
    loot: { gold: [0, 5], items: [{ id: 'rat_tail', chance: 1 }] },
  },
  wolf: {
    name: 'Wolf', creatureType: 'animal', hp: '2d8+4', ac: 14, attack: 3, damage: '1d6+1', speed: 3.6, xp: 70,
    saves: { fort: 5, ref: 5, will: 1 }, aggro: 7, color: '#777', shape: 'beast', size: 0.9,
    loot: { gold: [0, 0], items: [{ id: 'wolf_pelt', chance: 0.6 }] },
  },
  dire_wolf: {
    name: 'Dire Wolf', creatureType: 'animal', hp: '6d8+18', ac: 14, attack: 11, damage: '1d8+10', speed: 3.6, xp: 300,
  ...
  giant_spider: {
    name: 'Giant Spider', creatureType: 'vermin', hp: '4d8+4', ac: 14, attack: 4, damage: '1d8+3', speed: 3.0, xp: 150,
    saves: { fort: 5, ref: 4, will: 1 }, aggro: 6, color: '#2a1a2a', shape: 'spider', size: 1.1, poison: { dc: 12, STR: -2, rounds: 5 },
    loot: { gold: [0, 4], items: [] },
  },
  goblin: {
    name: 'Goblin', creatureType: 'goblinoid', hp: '1d8+1', ac: 15, attack: 2, damage: '1d6', speed: 3.0, xp: 45,
  ...
  goblin_archer: {
    name: 'Goblin Archer', creatureType: 'goblinoid', hp: '1d8+1', ac: 14, attack: 3, damage: '1d6', speed: 3.0, xp: 50,
    saves: { fort: 2, ref: 2, will: 0 }, aggro: 8, ranged: 8, color: '#5a8a3a', shape: 'humanoid', size: 0.75, weapon: 'bow',
    loot: { gold: [1, 8], items: [] },
  },
  goblin_shaman: {
    name: 'Goblin Shaman', creatureType: 'goblinoid', hp: '3d8+3', ac: 14, attack: 3, damage: '1d6', speed: 3.0, xp: 130,
    saves: { fort: 3, ref: 2, will: 4 }, aggro: 8, color: '#4a7a6a', shape: 'humanoid', size: 0.8, weapon: 'staff',
    spells: [{ id: 'magic_missile', level: 3, uses: 3 }],
    loot: { gold: [5, 20], items: [{ id: 'potion_cure_light', chance: 0.5 }] },
  },
  hobgoblin: {
    name: 'Hobgoblin', creatureType: 'goblinoid', hp: '2d8+4', ac: 16, attack: 4, damage: '1d8+1', speed: 3.0, xp: 90,
  ...
  goblin_chief: {
    name: 'Grubnash the Chief', creatureType: 'goblinoid', hp: '6d8+18', ac: 17, attack: 9, damage: '1d8+4', speed: 3.0, xp: 450, boss: true,
  ...
  ogre: {
    name: 'Ogre', creatureType: 'giant', hp: '4d8+11', ac: 16, attack: 8, damage: '2d8+7', speed: 2.8, xp: 400,
  ...
  bandit: {
    name: 'Bandit', creatureType: 'humanoid', hp: '2d8+2', ac: 15, attack: 3, damage: '1d6+1', speed: 3.1, xp: 70,
  ...
  skeleton: {
    name: 'Skeleton', creatureType: 'undead', hp: '1d12', ac: 13, attack: 1, damage: '1d6', speed: 2.8, xp: 55,
    saves: { fort: 0, ref: 0, will: 2 }, aggro: 6, color: '#e8e0d0', shape: 'humanoid', size: 1.0, weapon: 'blade', dr: { amount: 3, bypass: 'bludgeoning' },
    loot: { gold: [0, 3], items: [] },
  },
  skeleton_warrior: {
    name: 'Skeleton Warrior', creatureType: 'undead', hp: '4d12', ac: 16, attack: 6, damage: '1d8+2', speed: 2.8, xp: 180,
  ...
  zombie: {
    name: 'Zombie', creatureType: 'undead', hp: '2d12+3', ac: 11, attack: 2, damage: '1d6+1', speed: 1.8, xp: 65,
    saves: { fort: 0, ref: -1, will: 3 }, aggro: 6, color: '#6a8a5a', shape: 'humanoid', size: 1.0, weapon: 'none',
    loot: { gold: [0, 4], items: [] },
  },
  ghoul: {
    name: 'Ghoul', creatureType: 'undead', hp: '2d12+6', ac: 14, attack: 3, damage: '1d6+1', speed: 3.2, xp: 150,
  ...
  wight: {
    name: 'Wight', creatureType: 'undead', hp: '4d12+6', ac: 15, attack: 5, damage: '1d6+3', speed: 3.0, xp: 260,
  ...
  cultist: {
    name: 'Cultist of the Pale Hand', creatureType: 'humanoid', hp: '3d8+3', ac: 15, attack: 4, damage: '1d6+1', speed: 3.0, xp: 120,
  ...
  cult_acolyte: {
    name: 'Pale Hand Acolyte', creatureType: 'humanoid', hp: '3d8+3', ac: 14, attack: 3, damage: '1d6', speed: 3.0, xp: 150,
  ...
  cult_priest: {
    name: 'Vashti, Priestess of the Pale Hand', creatureType: 'humanoid', hp: '7d8+14', ac: 18, attack: 8, damage: '1d6+3', speed: 3.0, xp: 600, boss: true,
    saves: { fort: 7, ref: 3, will: 8 }, aggro: 8, color: '#8a2a9a', shape: 'humanoid', size: 1.05, weapon: 'mace',
    spells: [{ id: 'hold_person', level: 7, uses: 2 }, { id: 'cure_moderate_wounds', level: 7, uses: 2, self: true }, { id: 'doom', level: 7, uses: 1 }],
    loot: { gold: [60, 120], items: [{ id: 'crypt_key', chance: 1 }, { id: 'mace_1', chance: 1 }, { id: 'ring_of_wisdom', chance: 1 }] },
  },
  necromancer: {
    name: 'Malachar the Necromancer', creatureType: 'humanoid', hp: '9d4+27', ac: 19, attack: 6, damage: '1d6+1', speed: 3.0, xp: 1500, boss: true,
    saves: { fort: 6, ref: 5, will: 10 }, aggro: 9, color: '#1a1a2a', shape: 'humanoid', size: 1.1, weapon: 'staff',
    spells: [{ id: 'magic_missile', level: 9, uses: 4 }, { id: 'acid_arrow', level: 9, uses: 2 }, { id: 'ray_of_enfeeblement', level: 9, uses: 2 }, { id: 'vampiric_touch', level: 9, uses: 2 }],
