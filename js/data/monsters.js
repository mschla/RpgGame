...
export const MONSTERS = {
  ...
  goblin: {
    name: 'Goblin', sprite: 'goblin', creatureType: 'goblinoid', hp: '1d8+1', ac: 15, attack: 2, damage: '1d6', speed: 3.0, xp: 45,
  ...
  goblin_shaman: {
    name: 'Goblin Shaman', sprite: 'goblin_elite', creatureType: 'goblinoid', hp: '3d8+3', ac: 14, attack: 3, damage: '1d6', speed: 3.0, xp: 130,
  ...
  hobgoblin: {
    name: 'Hobgoblin', sprite: 'hobgoblin', creatureType: 'goblinoid', hp: '2d8+4', ac: 16, attack: 4, damage: '1d8+1', speed: 3.0, xp: 90,
  ...
  goblin_chief: {
    name: 'Grubnash the Chief', sprite: 'goblin_elite', spriteScale: 1.2, creatureType: 'goblinoid', hp: '6d8+18', ac: 17, attack: 9, damage: '1d8+4', speed: 3.0, xp: 450, boss: true,
  ...
  ogre: {
    name: 'Minotaur', sprite: 'minotaur', creatureType: 'giant', hp: '4d8+11', ac: 16, attack: 8, damage: '2d8+7', speed: 2.8, xp: 400,
  ...
  bandit: {
    name: 'Bandit', avatar: { gender: 'male', chest: 'leather_chest', legs: 'leather_pants', feet: 'leather_boots', main: 'longsword' }, creatureType: 'humanoid', hp: '2d8+2', ac: 15, attack: 3, damage: '1d6+1', speed: 3.1, xp: 70,
  ...
  wight: {
    name: 'Wight', sprite: 'skeleton_mage', creatureType: 'undead', hp: '4d12+6', ac: 15, attack: 5, damage: '1d6+3', speed: 3.0, xp: 260,
  ...
  cultist: {
    name: 'Cultist of the Pale Hand', avatar: { gender: 'male', chest: 'mage_vest', legs: 'mage_skirt', head: 'mage_hood', main: 'dagger' }, creatureType: 'humanoid', hp: '3d8+3', ac: 15, attack: 4, damage: '1d6+1', speed: 3.0, xp: 120,
  ...
  cult_priest: {
    name: 'Vashti, Priestess of the Pale Hand', avatar: { gender: 'female', chest: 'mage_vest', legs: 'mage_skirt', main: 'mace', off: 'buckler' }, creatureType: 'humanoid', hp: '7d8+14', ac: 18, attack: 8, damage: '1d6+3', speed: 3.0, xp: 600, boss: true,
  ...
  necromancer: {
    name: 'Malachar the Necromancer', avatar: { gender: 'male', chest: 'mage_vest', legs: 'mage_skirt', head: 'mage_hood', main: 'greatstaff' }, creatureType: 'humanoid', hp: '9d4+27', ac: 19, attack: 6, damage: '1d6+1', speed: 3.0, xp: 1500, boss: true,
